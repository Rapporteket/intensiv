...
NIRFigGjsnGrVar <- function(RegData, valgtVar, preprosess=1, hentData=0, valgtMaal='Gjsn',
                            ...
                            grType=99, nivaa = 0, InnMaate=99, dodInt='', erMann='', grVar='ShNavn', medKI=1,
                            velgDiag=0, overfPas = 0, lagFig=1, outfile='',...) {
  ...
  NIRUtvalg <- NIRUtvalgEnh(
    RegData=RegData, datoFra=datoFra, datoTil=datoTil, aar=aar, minald=minald, maxald=maxald,
    erMann=erMann, InnMaate=InnMaate, dodInt=dodInt, grType=grType, nivaa = nivaa,
    overfPas = overfPas, velgDiag=velgDiag)

             ...
             selectInput(
               ...
               choices = c(
                 ...
                 'BehandlingSamarbeid' = 'BehandlingSamarbeid_2',
                  'BehandlingBesvarerHoeflighetRespektMedfoelelse' = 'BehandlingBesvarerHoeflighetRespektMedfoelelse_2',
                  'SykepleierOmsorg' = 'SykepleierOmsorg_2',
                  'SykepleierKommunikasjon' = 'SykepleierKommunikasjon_2',
                  'LegeBehandling' = 'LegeBehandling_2',
                  ...
                  'ForklaringForstaaelse' = 'ForklaringForstaaelse_2',
                  'InformasjonsAerlighet' = 'InformasjonsAerlighet_2',
                  'InformasjonOmForloep' = 'InformasjonOmForloep_2',
                  'InformasjonsOverensstemmelse' = 'InformasjonsOverensstemmelse_2',
                  'BeslutningsInvolvering' = 'BeslutningsInvolvering_2',
                  'BeslutningsStoette' = 'BeslutningsStoette_2',
                  'BeslutningsKontroll' = 'BeslutningsKontroll_2',
                  'BeslutningsTid' = 'BeslutningsTid_2',
                  'LivsLengde' = 'LivsLengde_2',

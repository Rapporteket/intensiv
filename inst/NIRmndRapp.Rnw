...
#datoFra1Aar <- as.Date(paste0(1900+idag$year-1,'-', ifelse(idag$mon==11, 1, idag$mon+2), '-', '01'), tz='UTC')
...
#RegData bare for siste 6 mnd og for å få indeks:
...
tabBelegg <- tabBelegg(RegData=RegDataEget, datoTil=datoTil, tidsenhet = 'Mnd')

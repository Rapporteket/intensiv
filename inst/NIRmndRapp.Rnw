...
\begin{frame}[fragile] {Registreringsforseinking} {invisible}
...
alderDIV <- cbind(
      'Sist månad' = alderTabInnhold(RegDataEgetMnd),
...
rownames(alderDIV) <- c('Minimum:', 
                        '25% av pasientene er under:', 
                        'Median:','Gjennsomsnitt:',
                        '25% av pasientene er over:', 
                        'Maksimum:',
                        'Pasientar < 16 år', 
                        'Pasientar >= 80 år')

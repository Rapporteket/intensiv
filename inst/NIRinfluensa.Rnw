...
\item Dato er basert på dato for når skjemaet ble opprettet fordi dette er den eneste datoen som finnes for alle registreringer. 
...
print(xtable::xtable(TabUkeTotFerdig[indAntRader,], digits=0, #align=c('l', rep('r', ncol(TabUkeTot))),
		caption='Antall influensatilfeller basert på ferdigstilte skjema siste 15 uker og totalt, sesongen 2018/19.'),
		#Totalt antall skjema er antall registrerte influensaskjema.'),
		sanitize.rownames.function = identity)
@
\end{frame}

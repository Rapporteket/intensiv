...
knitr::opts_chunk$set(fig.path='')	#Settes også i rapbase
...
tabRespShType <- rbind(
	...
	'Hele landet' = c(RespAlle[4], RespAlle[3], AndelResp[4], paste(RespAlle[1],' - ',RespAlle[6], sep=''))
					)
...
for (k in 1:3) {
	...
	tabStatusUt <- xtable(tabStatusUt, digits=c(0,0,1), align=c('l','r','r'), 
			caption=paste0('Status ved utskrivning, ', UtvTxt[k], '. 
				NB: Tabellen er bare gyldig for t.o.m. desember 2015',),

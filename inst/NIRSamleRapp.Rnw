...
NIRdataRestShType <- NIRdata[setdiff(ind$EgenShType,ind$Eget), ]
...
alderDIV <- cbind('Egen enhet'= summary(NIRdataEget$Alder)[1:6],
			'Andre, egen sykehustype'= summary(NIRdataRestShType$Alder)[1:6])
...
liggetidDIV <- cbind('Egen enhet'= summary(NIRdataEget$liggetid)[1:6],
			'Andre, egen sykehustype'= summary(NIRdataRestShType$liggetid)[1:6])

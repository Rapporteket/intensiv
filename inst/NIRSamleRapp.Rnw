...
if (!exists('NIRdata')){
      NIRdata <- NIRRegDataSQL(datoFra = '2011-01-01')
}
@
...
#NIRdata$ShType <- factor(NIRdata$ShType, levels=c(1,3))	#Lager krøll senere
...
#NIRutvalg <- NIRUtvalgEnh(RegData=NIRdata, datoFra=datoFra, datoTil=datoTil, fargepalett='BlaaRapp')
...
dum <- NIRAndeler(RegData=NIRdata, valgtVar='alder', preprosess=0, hentData=0, datoFra=datoFra, 
	datoTil=datoTil, enhetsUtvalg=1, reshID=reshID, outfile='FigAlderFord.pdf')
dum <- NIRGjsnGrVar(RegData=NIRdata, valgtVar='alder', valgtMaal='Gjsn', preprosess=0, hentData=0, 
                       grType=ShTypeEgen, datoFra=datoFra, datoTil=datoTil, outfile='FigAlderGjsn.pdf')
dum <- NIRGjsnGrVar(RegData=NIRdata, valgtVar='alder', valgtMaal='Med', preprosess=0, hentData=0, 
...
\centering \includegraphics[width= \Sexpr{figKrymp1}\textwidth]{FigAlderMed.pdf} 
 \caption{Gjennomsnitt og median alder ved \Sexpr{paste0(ShTypeEgenTxt,'sykehus.')}}	
...
dum <- NIRAndeler(RegData=NIRdata, valgtVar='alder', preprosess=0, hentData=0, erMann=0,
	datoFra=datoFra, datoTil=datoTil, enhetsUtvalg=3, reshID=reshID, outfile='FigAlderK.pdf')
dum <- NIRAndeler(RegData=NIRdata, valgtVar='alder', preprosess=0, hentData=0, erMann=1,
...
dum <- NIRAndeler(RegData=NIRdata, valgtVar='liggetid', preprosess=0, hentData=0, datoFra=datoFra, 
	datoTil=datoTil, enhetsUtvalg=1, reshID=reshID, outfile='FigLiggetidFordAlle.pdf')

dum <- NIRGjsnGrVar(RegData=NIRdata, valgtVar='liggetid', valgtMaal='Gjsn', preprosess=0, hentData=0,  
			grType=ShTypeEgen, datoFra=datoFra, datoTil=datoTil, outfile='FigLiggetidGjsn.pdf')
dum <- NIRGjsnGrVar(RegData=NIRdata, valgtVar='liggetid', valgtMaal='Med', preprosess=0, hentData=0,  
...
NregReinn <- length(which(NIRdata$ReAdmitted %in% 1:2))
AndelReinnAlle <- round(100*length(which(NIRdata$ReAdmitted == 1))/length(which(NIRdata$ReAdmitted %in% 1:2)), 1)
AndelReinnEgen <- round(100*length(which(NIRdataEget$ReAdmitted == 1))/length(which(NIRdataEget$ReAdmitted %in% 1:2)),1)

dum <- NIRAndelerGrVar(RegData=NIRdata, valgtVar='reinn', preprosess=0, hentData=0, grType=ShTypeEgen, datoFra=datoFra, 
...
dum <- NIRAndelerGrVar(RegData=NIRdata, valgtVar='innMaate', preprosess=0, hentData=0, grType=ShTypeEgen, datoFra=datoFra, 
...
dum <- NIRGjsnGrVar(RegData=NIRdata, valgtVar='NEMS', valgtMaal='Gjsn', preprosess=0, hentData=0,  
...
dum <- NIRAndeler(RegData=NIRdata, valgtVar='respiratortid', preprosess=0, hentData=0, datoFra=datoFra, 
	datoTil=datoTil, enhetsUtvalg=3, reshID=reshID, outfile='FigResptidFord.pdf')
dum <- NIRGjsnGrVar(RegData=NIRdata, valgtVar='respiratortid', valgtMaal='Gjsn', preprosess=0, hentData=0,  
		grType=ShTypeEgen, datoFra=datoFra, datoTil=datoTil, outfile='FigResptidGjsn.pdf') 
dum <- NIRGjsnGrVar(RegData=NIRdata, valgtVar='respiratortid', valgtMaal='Med', preprosess=0, hentData=0,  
...
\centering \includegraphics[width= \Sexpr{figKrymp1}\textwidth]{FigResptidFord.pdf} 
  \caption{Fordeling av respiratortid ved \Sexpr{paste0(ShTypeEgenTxt,'sykehus')}}
...
\centering \includegraphics[width= \Sexpr{figKrymp1}\textwidth]{FigResptidMed.pdf} 
 \caption{Gjennomsnittlig og median respiratortid ved \Sexpr{paste0(ShTypeEgenTxt,'sykehus')}.}	
  \label{fig:ResptidMM}
\end{figure}
...
dum <- NIRAndeler(RegData=NIRdata, valgtVar='SAPSII', preprosess=0, hentData=0, datoFra=datoFra, 
	datoTil=datoTil, enhetsUtvalg=3, reshID=reshID, outfile='FigSAPSford.pdf')
dum <- NIRGjsnGrVar(RegData=NIRdata, valgtVar='SAPSII', valgtMaal='Gjsn', preprosess=0, hentData=0,  
...
dum <- NIRGjsnGrVar(RegData=NIRdata, valgtVar='SMR', valgtMaal='Gjsn', preprosess=0, hentData=0,  
...
dum <- NIRGjsnGrVar(RegData=NIRdata, valgtVar='liggetid', valgtMaal='Gjsn', preprosess=0, hentData=0, dodInt=1, 

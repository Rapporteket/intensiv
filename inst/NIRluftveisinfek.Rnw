...
Dokumentet viser resultater fra ferdigstilte opphold med luftveisinfeksjon. (Opphold i kladd er ikke med.) At et opphold er ferdigstilt vil si at opplysningene er kontrollert og ferdig registrert.
...
print(xtable::xtable(RegHF, digits=0,
                     align = c('l', 'l', 'l', 'r'),
                     caption = 'Antall luftveispasienter med lkuftveisinfeksjon som hovedårsak til innleggelse'),

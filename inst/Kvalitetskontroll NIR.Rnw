...
variabler <- c('TypeOfAdmission','TransferredStatus','PatientTransferredFromHospital','PatientTransferredToHospital','ChronicDiseases','Glasgow','Age','SystolicBloodPressure',
               ...
               'FormType','DischargedIntensiveStatus','DateAdmittedIntensive','DateDischargedIntensive','DaysAdmittedIntensiv','AgeAdmitted','Respirator','Saps2ScoreNumber','Saps2Score','MoreThan24Hours',

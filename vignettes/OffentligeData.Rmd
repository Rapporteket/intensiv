...
#Respiratortid             
            RegData$RespTidNevner  <- 0
            RegData$RespTidNevner[which(as.numeric(RegData$respiratortid)>0)] <- 1 
            RegData$RespTidTeller <- 0  
            RegData$RespTidTeller[which(as.numeric(RegData$respiratortid)>2.5)] <- 1 
...
#SMR
            ...
            RegData$SMRNevner <- 0
            RegData$SMRNevner[indMed] <- RegData$SMR[indMed] #Estimert dødelighet
            RegData$Dod30 <- 0
            RegData$SMRTeller[indMed] <- RegData$Dod30[indMed] #Observert dødelighet
            #NB: Gjennomsnitt av teller deles på gjennomsnitt av nevner!!
            xAkseTxt <- 'Observert / estimert dødelighet'
            KImaal <- 0.7  #SMR <0.7 

KvalIndVarUt <- c('ReinnNevner', 'ReinnTeller', 'RespTidNevner','RespTidTeller', 'SMRNevner', 'SMRTeller')

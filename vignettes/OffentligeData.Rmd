...
Både reinnleggelse og respiratortid kan representeres som indikatorvariable. SMR er observert dødelighet (innen 30 dager) ift. estimert dødelighet (standardisert SAPSII-skår). Estimert dødelighet kan ikke representeres med en indikatorvariabel. Variabelen SMR har ikke god nok kvalitet og vil derfor ikke bli benyttet som offentlig kvalitetsindikator.

## Anonymisering, intensivregisteret
Det er an akseptert tommelfingerregel at data kan betraktes som anonyme hvis enhver gruppering av dataene inneholder minst 4 overvasjoner.
